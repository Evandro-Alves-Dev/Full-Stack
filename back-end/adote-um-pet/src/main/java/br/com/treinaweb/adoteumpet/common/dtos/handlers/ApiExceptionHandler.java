package br.com.treinaweb.adoteumpet.common.dtos.handlers;

import br.com.treinaweb.adoteumpet.common.dtos.ErrorResponse;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private Map<String, List<String>> convertFieldErrors(List<FieldError> fieldErrorList) {
